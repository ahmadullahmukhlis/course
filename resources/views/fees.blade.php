                                ...
                                @foreach ($fees as $item)
                                    <tr>
                                        ...
                                        <td class="btn btn-warning"><a
                                                href="{{ route('fees.edit', $item->id) }}">edit</a></td>
                                        <td class="btn btn-warning"><a
                                                href="{{ route('fees.destroy', $item->id) }}">delete</a></td>
                                        <td class="btn btn-warning"><a
                                                href="{{ route('fees.show', $item->id) }}">profile</a></td>
